...
For Gravis CAT323 on the integration x86, use [gravis-cat323](../gravis-cat323/SKILL.md) instead of the M4 wrapper and machine-ready procedure below. CAT323 already has native Gravis low-level control, estimation, and elevation mapping on Orin A; integration runs the high-level adapter/controller and excavation mapping. Do not start a second estimator or apply the M4 hydraulic-service example and armrest/radio gates without checking the CAT323 contract.
