---
name: ultragoal
description: Design, critique, or activate durable Codex goals. Use for explicit goal-mode requests, persistent objectives, verifiers, completion proof, or goal trees.
---
