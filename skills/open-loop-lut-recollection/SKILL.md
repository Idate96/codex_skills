...
The workflow below collects M445 current in amperes. CAT323's native LUT uses
cylinder m/s and normalized raw output; its acquisition interface and XML export
need adaptation before this hardware runner or candidate builder can be used.
