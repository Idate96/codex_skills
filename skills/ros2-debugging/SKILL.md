...
- For Gravis CAT323 on integration x86, also use [gravis-cat323](../gravis-cat323/SKILL.md) for the runtime/observer DDS profiles and native map contract. Keep topic discovery, complete message receipt, and mapper acceptance as separate checks.
