---
name: chrome-cdp
description: Control an existing local Chrome session through CDP for inspection, screenshots, navigation, and interaction. Use only with explicit user approval.
---
